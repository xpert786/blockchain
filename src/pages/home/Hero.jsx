  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 max-w-3xl px-4 mt-20">
        <span className="bg-[#0A2A2E] text-white px-4 py-1 rounded-full text-[14px] ">
        ...
        <p className="mt-4 text-base md:text-[24px] text-gray-200 text-[24px]">
          Streamline SPV creation, investor onboarding, and compliance workflows
          with our comprehensive platform.
        </p>

        <button className="mt-6 bg-[#00F0C3] text-[#0A2A2E] px-6 py-2 rounded-lg font-semibold hover:bg-teal-300 transition">
          Contact Us
        </button>
      </div>
    </section>
