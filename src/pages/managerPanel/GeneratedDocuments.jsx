  ...
  return (
    <div>
      ...
      <div className="space-y-4">
        {documents.map((doc) => (
          <div key={doc.id} className="bg-white rounded-lg p-6 !border border-gray-200 shadow-sm">
                  ...
                  <div className="mt-4">
                    ...
                    <div className="flex flex-wrap gap-8">
                      {doc.signatories.map((signatory, index) => (
                        <div key={index} className="flex items-center bg-purple-50 rounded-lg px-8 py-4 min-w-[380px]">
