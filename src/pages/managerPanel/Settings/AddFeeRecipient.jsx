...
const AddFeeRecipient = () => {
  ...
  // --- Configuration ---
  const BASE_API_URL = "http://72.61.251.114/blockchain-backend/api/syndicate/settings/fee-recipient/";
  ...
  const handleSave = async () => {
    ...
    // Standardizing to PATCH for both create and update based on user requirement
    const method = 'PATCH';

    // Determine URL: Append ID for explicit updates, use base URL for "save new setting" logic
