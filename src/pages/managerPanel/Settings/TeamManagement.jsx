          ...
          <tbody className="bg-white divide-y divide-gray-200">
            {teamMembers.map((member) => (
              <tr key={member.id} className="hover:bg-gray-50">
                ...
                <td className="px-4 py-3 whitespace-nowrap">
                  <select className="text-sm border-0 rounded-md px-3 py-1 focus:outline-none focus:ring-0 focus:border-0 focus-visible:outline-none focus-visible:ring-0 active:ring-0 font-poppins-custom bg-transparent cursor-pointer">
