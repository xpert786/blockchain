      ...
      <div className="flex-1 bg-white rounded-xl p-6 sm:p-8 lg:px-10 mx-auto mb-10 lg:mb-10 w-full max-w-4xl">
        <div className="mx-auto">
          ...
          <div className="space-y-8">
            ...
            <div>
              <label className="block text-base font-medium text-[#0A2A2E] mb-2 font-poppins-custom text-center sm:text-left">
                Which of the following investment strategies (on products) best match your preferences?
              </label>
              <p className="text-sm text-[#748A91] mb-4 font-poppins-custom text-center sm:text-left">
                Tell us more about why you want to invest on Unlocksley
              </p>
