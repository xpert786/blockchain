    ...
    <div className="min-h-screen bg-[#F4F6F5]">
      ...
      <main className="w-full px-6 py-8">
        ...
        <div className="flex items-center justify-between mb-8 bg-white rounded-lg p-6">
          ...
          <div className="px-4 py-2 bg-gray-100 text-[#0A2A2E] rounded-lg font-medium font-poppins-custom"
          ...
          {wishlistItems.map((item, index) => (
            <div key={index} className="bg-white rounded-lg p-6 border border-gray-200">
              ...
              <div className="flex items-start justify-between mb-6">
                <h3 className="text-xl font-semibold text-[#0A2A2E] font-poppins-custom">
                  {item.name}
                </h3>
                {/* Tags */}
              ...
              <div className="bg-[#F9F8FF] rounded-lg p-2 flex flex-row items-center justify-between"
                ...
                >
                  <p className="text-xs text-[#748A91] font-poppins-custom mb-1">Estimated Min</p>
                  <p className="text-base font-semibold text-[#0A2A2E] font-poppins-custom">{item.estimatedMin}</p>
                </div>
                <div className="bg-[#F9F8FF] rounded-lg p-2 flex flex-row items-center justify-between"
                style={{border: "0.5px solid #E2E2FB"}}
                >
                  <p className="text-xs text-[#748A91] font-poppins-custom mb-1">Updates</p>
                  <p className="text-base font-medium text-[#0A2A2E] font-poppins-custom">{item.updates}</p>
                </div>
                <div className="bg-[#F9F8FF] rounded-lg p-2 flex flex-row items-center justify-between"
                style={{border: "0.5px solid #E2E2FB"}}
                >
                  <p className="text-xs text-[#748A91] font-poppins-custom mb-1">Added</p>
                  <p className="text-base font-medium text-[#0A2A2E] font-poppins-custom">{item.added}</p>
                </div>
              </div>
              ...
              <div className="flex items-center gap-3">
                ...
                <path d="M0.5 3H11.75M10.5 3V11.75C10.5 12.375 9.875 13 9.25 13H3C2.375 13 1.75 12.375 1.75 11.75V3M3.625 3V1.75C3.625 1.125 4.25 0.5 4.875 0.5H7.375C8 0.5 8.625 1.125 8.625 1.75V3M4.875 6.125V9.875M7.375 6.125V9.875" stroke="#001D21" stroke-linecap="round" stroke-linejoin="round"/>
                </svg>
