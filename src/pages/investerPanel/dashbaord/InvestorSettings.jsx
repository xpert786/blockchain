...
const renderToggle = (isOn, name, handler) => (
  ...
  >
    <span
      className={`block w-4 h-4 rounded-full bg-white transition-transform duration-200 ease-in-out ${isOn ? "translate-x-full bg-[#00F0C3]" : "translate-x-0 bg-[#0A2A2E] bg-opacity-70"
        }`}
    />
  </div>
);
                  ...
                  <div className="absolute top-full left-0 right-0 mt-2 bg-white border border-[#E5E7EB] rounded-md shadow-lg z-10 max-h-96 overflow-y-auto">
                    {settingsTabs.map((tab) => (
                      <button
                        ...
                        className={`w-full text-left px-4 py-3 text-sm font-medium font-poppins-custom transition-colors border-b border-[#E5E7EB] last:border-b-0 ${tab === activeTab
              ...
              <div className="hidden lg:block bg-white border border-[#E5E7EB] rounded-md p-4 space-y-2">
                {settingsTabs.map((tab) => (
                  <button
                    ...
                    className={`w-full text-left px-4 py-3 rounded-md text-sm font-medium font-poppins-custom transition-colors ${tab === activeTab
                        ? "bg-[#00F0C3] text-[#001D21]"
                    ...
                    <>
                      ...
                      <div className="flex justify-start">
                        <button
                          ...
                          className={`px-6 py-3 bg-[#00F0C3] text-[#001D21] rounded-md text-sm font-medium font-poppins-custom hover:bg-[#00D9B0] transition-colors ${isSavingIdentity ? "opacity-50 cursor-not-allowed" : ""
                            }`}
                        >
                    ...
                    <>
                      ...
                      <div className="flex justify-start">
                        <button
                          ...
                          className={`px-6 py-3 bg-[#00F0C3] text-[#001D21] rounded-md text-sm font-medium font-poppins-custom hover:bg-[#00D9B0] transition-colors ${isSavingAccreditation ? "opacity-50 cursor-not-allowed" : ""
                            }`}
                        >
                    ...
                    <>
                      ...
                      <div className="flex justify-start">
                        <button
                          ...
                          className={`px-6 py-3 bg-[#00F0C3] text-[#001D21] rounded-md text-sm font-medium font-poppins-custom hover:bg-[#00D9B0] transition-colors ${isSavingTax ? "opacity-50 cursor-not-allowed" : ""
                            }`}
                        >
                    ...
                    <>
                      <div className="space-y-6">
                        <div className="space-y-4">
                          ...
                          {[
                            ...
                            <div
                              key={item.title}
                              className={`flex flex-col md:flex-row md:items-center md:justify-between gap-3 ${index < 2 ? "border-b border-[#E5E7EB] pb-4" : ""
                                }`}
                            >
                              <div>
                      ...
                      <div className="flex justify-start pt-2">
                        <button
                          ...
                          className={`px-6 py-3 bg-[#00F0C3] text-[#001D21] rounded-md text-sm font-medium font-poppins-custom hover:bg-[#00D9B0] transition-colors ${isSavingEligibility ? "opacity-50 cursor-not-allowed" : ""
                            }`}
                        >
                    ...
                    <>
                      ...
                      <div className="flex justify-start pt-2">
                        <button
                          ...
                          className={`px-6 py-3 bg-[#00F0C3] text-[#001D21] rounded-md text-sm font-medium font-poppins-custom hover:bg-[#00D9B0] transition-colors ${isSavingFinancial ? "opacity-50 cursor-not-allowed" : ""
                            }`}
                        >
                    ...
                    <>
                      ...
                      <div className="flex justify-start pt-2">
                        <button
                          ...
                          className={`px-6 py-3 bg-[#00F0C3] text-[#001D21] rounded-md text-sm font-medium font-poppins-custom hover:bg-[#00D9B0] transition-colors ${isSavingPortfolio ? "opacity-50 cursor-not-allowed" : ""
                            }`}
                        >
                      ...
                      <div className="bg-white border border-[#E5E7EB] rounded-3xl p-4 sm:p-6 space-y-6">
                          ...
                          <div className="space-y-3">
                            ...
                            <div className="flex justify-start">
                              <button
                                ...
                                className={`px-4 py-2 bg-[#00F0C3] text-[#001D21] rounded-md text-sm font-medium font-poppins-custom hover:bg-[#00D9B0] transition-colors ${isChangingPassword ? "opacity-50 cursor-not-allowed" : ""
                                  }`}
                              >
                        ...
                        <div className="flex justify-start">
                          <button
                            ...
                            className={`px-6 py-3 bg-[#00F0C3] text-[#001D21] rounded-md text-sm font-medium font-poppins-custom hover:bg-[#00D9B0] transition-colors ${isSavingSecurityPrivacy ? "opacity-50 cursor-not-allowed" : ""
                              }`}
                          >
                ...
                <section className="bg-white border border-[#E5E7EB] rounded-3xl p-4 sm:p-6 space-y-6">
                  ...
                  <div className="flex justify-start pt-2">
                    <button
                      ...
                      className={`px-6 py-3 bg-[#00F0C3] text-[#001D21] rounded-md text-sm font-medium font-poppins-custom hover:bg-[#00D9B0] transition-colors ${isSavingCommunication ? "opacity-50 cursor-not-allowed" : ""
                        }`}
                    >
