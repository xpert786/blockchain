    ...
    <div className="min-h-screen bg-[#F4F6F5]">
      ...
      <main className="w-full px-6 py-8">
        ...
        <div className="flex items-center justify-between mb-8">
          ...
          <button className="px-6 py-3 bg-[#00F0C3] text-[#0A2A2E] rounded-lg font-medium font-poppins-custom flex items-center gap-2 hover:bg-green-600 transition-colors">
        ...
        <div className="grid grid-cols-4 gap-4 mb-4">
          ...
          <div className="bg-[#CAE6FF] rounded-lg p-6 relative overflow-hidden">
            <div className="flex flex-row justify-between mb-7 ">
                <p className="text-sm text-[#0A2A2E] font-poppins-custom mb-2">Total Portfolio Value</p>
            ...
            <div className="flex flex-row justify-between items-center">
                <p className="text-2xl  text-[#0A2A2E] font-poppins-custom mb-1">$2,847,500</p>
                <p className="text-sm text-green-600 font-poppins-custom">+26.6% overall</p>
            </div>
          ...
          <div className="bg-green-100 rounded-lg p-6 relative overflow-hidden">
            <div className="flex flex-row justify-between mb-7 ">
            <div className="">
                    <p className="text-sm text-[#0A2A2E] font-poppins-custom mb-2">Total Invested</p>   
                </div>
                    <GrowthIcon />
                
                </div>
                <div className="flex flex-row justify-between items-center">
                    <p className="text-2xl  text-[#0A2A2E] font-poppins-custom mb-1">$2,250,000</p>
                    <p className="text-sm text-green-600 font-poppins-custom">+26.6% overall</p>
                </div>
            </div>
          ...
          <div className="bg-[#CAE6FF] rounded-lg p-6 relative overflow-hidden">
            <div className="flex flex-row justify-between mb-7"> 
                <p className="text-sm text-[#0A2A2E] font-poppins-custom mb-2">Total Gains</p>
                <GrowthIcon />
            </div>
          <div className="flex flex-row justify-between items-center">
                <p className="text-2xl font-bold text-[#0A2A2E] font-poppins-custom mb-1">$597,500</p>
                <p className="text-sm text-[#0A2A2E] font-poppins-custom">Unrealized gains</p>
            </div>
            </div>
          ...
          <div className="bg-orange-100 rounded-lg p-6 relative overflow-hidden">
            <div className="flex flex-row justify-between mb-7">   
                <p className="text-sm text-[#0A2A2E] font-poppins-custom mb-2">Active Investments</p>
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div className="flex flex-row justify-between items-center">
                <p className="text-2xl font-bold text-[#0A2A2E] font-poppins-custom mb-1">14</p>
                <p className="text-sm text-[#0A2A2E] font-poppins-custom">3 pending</p>
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-2 gap-6 mb-8">
          ...
          <div className="bg-white rounded-lg p-6 pb-12 border border-gray-200">
            <div className="flex items-center justify-between mb-4">
              <h3 className="text-lg font-semibold text-[#0A2A2E] font-poppins-custom">Portfolio Performance</h3>
          ...
          <div className="bg-white rounded-lg p-6 border border-gray-200">
            <div className="flex items-center justify-between mb-4">
              <h3 className="text-lg font-semibold text-[#0A2A2E] font-poppins-custom">{chartTitle}</h3>
              <div className="relative" ref={chartDropdownRef}>
                <button 
                  onClick={() => setShowChartDropdown(!showChartDropdown)}
                  className="px-3 py-1.5 bg-[#F4F6F5] text-[#0A2A2E] rounded-lg font-medium font-poppins-custom flex items-center gap-2 text-sm"
                ...
                {showChartDropdown && (
                  <div className="absolute top-full right-0 mt-2 bg-white rounded-lg shadow-lg z-10 min-w-[120px] border border-gray-200">
                    <button
                      onClick={() => {
                ...
                {chartData.map((entry, index) => (
                  <div key={index} className="flex items-center justify-between">
                    <div className="flex items-center gap-2">
                      ...
                      ></div>
                      <span className="text-sm text-[#0A2A2E] font-poppins-custom">{entry.name}</span>
                    </div>
                    <span className="text-sm font-semibold text-[#0A2A2E] font-poppins-custom">
        ...
        <div className="mb-8">
          <div className="mb-6">
            <h2 className="text-2xl font-semibold text-[#0A2A2E] font-poppins-custom mb-2">
              Your Investments
            </h2>
            <p className="text-base text-[#748A91] font-poppins-custom">
              ...
              <div key={index} className="bg-white rounded-lg p-6 border border-gray-200">
                <div className="flex items-start justify-between mb-4">
                  <div className="flex-1">
                    ...
                    <div className="flex items-center gap-2 text-sm text-[#748A91] font-poppins-custom">
                ...
                <div className="grid grid-cols-3 gap-6 mb-4">
                    ...
                    >
                        <p className="text-xs text-[#748A91] font-poppins-custom mb-1">Invested</p>
                        <p className="text-base font-semibold text-[#0A2A2E] font-poppins-custom">{investment.invested}</p>
                  </div>
                  <div className="bg-[#F9F8FF] rounded-lg p-2 flex flex-row items-center justify-between"
                style={{border: "0.5px solid #E2E2FB"}}
                >
                    <p className="text-xs text-[#748A91] font-poppins-custom mb-1">Current Value</p>
                    <p className="text-base font-semibold text-[#0A2A2E] font-poppins-custom">{investment.currentValue}</p>
                  </div>
                  <div className="bg-[#F9F8FF] rounded-lg p-2 flex flex-row items-center justify-between"
                style={{border: "0.5px solid #E2E2FB"}}
                >
                    <p className="text-xs text-[#748A91] font-poppins-custom mb-1">Gain/Loss</p>
                    <p className={`text-base  font-poppins-custom ${
                ...
                <button className="px-4 py-2 bg-[#F4F6F5] text-[#0A2A2E] rounded-lg hover:bg-gray-50 transition-colors font-medium font-poppins-custom text-sm"
                style={{border: "0.5px solid #01373D"}}
                >
                  View Details
                </button>
