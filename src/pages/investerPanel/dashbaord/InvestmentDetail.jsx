      ...
      <div className="w-full px-4 sm:px-6 py-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
            ...
            <div className="bg-white rounded-lg p-6 border border-gray-200">
              ...
              <p className={`text-2xl font-semibold font-poppins-custom ${
                (investment.gain_loss_percentage || 0) >= 0 ? "text-[#22C55E]" : "text-[#ED1C24]"
              }`}>
          ...
          <div className="bg-white rounded-lg p-6 border border-gray-200 mb-8">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
              ...
              <div className="bg-[#F9F8FF] rounded-lg p-4 border border-[#E2E2FB]">
                ...
                <p className={`text-lg font-semibold font-poppins-custom ${
                  (investment.gain_loss_percentage || 0) >= 0 ? "text-[#22C55E]" : "text-[#ED1C24]"
                }`}>
                  {investment.gain_loss_formatted || "$0 (0%)"}
                </p>
