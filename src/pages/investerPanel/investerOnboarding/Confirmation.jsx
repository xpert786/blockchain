    ...
    <div className="min-h-screen p-6" style={{ backgroundColor: '#F4F6F5' }}>
      ...
      <div className="flex min-h-[calc(100vh-200px)] px-6 pb-6">
        ...
        <div className="flex-1 bg-white rounded-xl p-6 m-4">
          <div className="px-10 mx-auto flex flex-col items-center text-center">
            {/* Title */}
            <h1 className="text-3xl text-[#0A2A2E] mb-2 font-poppins-custom font-semibold">Onboarding Completion Confirmation</h1>
            
            {/* Subtitle */}
            <p className="text-sm text-[#748A91] mb-15 font-poppins-custom">
              You're all set!
            </p>
            ...
            {/* Welcome Message */}
            <h2 className="text-4xl font-bold text-[#0A2A2E] mb-4 font-poppins-custom">
              Welcome Aboard, John.
            </h2>

            {/* Instruction Text */}
            <p className="text-lg text-[#748A91] mb-10 font-poppins-custom">
              Start exploring SPVs and manage your investments.
            </p>

            {/* Active Profile Message */}
            <p className="text-lg text-[#001D21] mb-12 font-poppins-custom">
            ...
            <button
              ...
              className="px-6 py-2 bg-[#00F0C3] text-[#001D21] rounded-xl hover:bg-[#00C4B3] transition-colors font-medium font-poppins-custom text-lg"
            >
              Go to My Dashboard
            </button>
          </div>
