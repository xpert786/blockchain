  ...
  useEffect(() => {
    ...
    const fetchProgress = async () => {
      try {
        ...
        const res = await fetch("http://72.61.251.114/blockchain-backend/api/investor-progress/", {
          method: "GET",
          headers: {
        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="space-y-3 mb-6">
            {documents.map((doc, index) => (
              ...
              >
                <span
                  className={`text-sm font-semibold ${doc.value ? "text-green-600" : "text-red-500"
                    }`}
                >
